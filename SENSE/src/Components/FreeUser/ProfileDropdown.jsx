...
const ProfileDropdown = ({ onLogout }) => {
  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      ...
      <svg className="text-gray-500 hover:text-gray-200 duration-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="100" height="50" fill="currentColor" viewBox="0 0 24 24">
