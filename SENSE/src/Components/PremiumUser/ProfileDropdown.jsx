  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      <div onClick={() => setIsOpen(!isOpen)} className="cursor-pointer">
        <svg className="text-gray-500 hover:text-gray-200 dark:text-white dark:hover:text-gray-300 duration-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="100" height="50" fill="currentColor" viewBox="0 0 24 24">
