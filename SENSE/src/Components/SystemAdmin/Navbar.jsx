        ...
        <div className="relative inline-block" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute mt-2 w-48 text-black bg-white rounded-md shadow-lg z-20 right-0">
              <div className="py-1">
                <button className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-center" onClick={() => handleNavigate('/updateLandingPage')}>Landing Page</button>
